                ...
                <form action="{{ route('manager/store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control w-100" name="harga" style="border-style: groove;" id="harga" required>
                        </div>
                        <div class="mb-3">
                            <label for="deskripsi" class="form-label">Deskripsi :</label>
                            <input type="text" class="form-control w-100" name="deskripsi" style="border-style: groove;" id="deskripsi" required>
                        </div>
                        <div class="mb-3">
                            <label for="ketersediaan" class="form-label">Ketersediaan :</label>
                            <input type="number" class="form-control w-100" name="ketersediaan" style="border-style: groove;" id="ketersediaan" required>
                        </div>
